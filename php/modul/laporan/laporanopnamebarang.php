            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <h1 class="h3 mb-2 text-gray-800">Laporan Opname Stok</h1>
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <br>
                                <h5 class="h5 mb-2 text-gray-800">Periode: <b><?php echo $tglAwal;?></b> - <b><?php echo $tglAkhir;?></b></h5>
                                <form method="POST" action="laporanopnamebarang.php">
                                    <div class="row">
                                        <div class="col">
                                            <div class="row">
                                                <div class="col">
                                            ...
                                            <a class="btn btn-secondary" href="cetaklaporanopname.php?awal=<?php echo $tgAwal;?>&&akhir=<?php echo $tgAkhir;?>" target="_blank"><i class="fas fa-print">Cetak</i></a>
                                        </div>
                                    </div>
                                </form>
                                <br>
                                ...
                                <!-- Datatables -->
                                <div id="datatables">
                                    <table class="table table-stripped table-bordered table-hover" id="dtLaporanOpname" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                                $tampilLaporanOpname= mysqli_query($conn,"SELECT * FROM tbdetailopname
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?=$idDetailOpname;?></td>
