                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" id="tgAkhir" name="tgAkhir" value="<?php echo $tgAkhir;?>" oninvalid="this.setCustomValidity('Pilih tanggal pada kolom pengisian ini!')" onchange="this.setCustomValidity('')" required>
                                                    </div>
                                                </div>
                                            </div>
